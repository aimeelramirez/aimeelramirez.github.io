import React, { useState, type PropsWithChildren, type FC, forwardRef } from 'react';
...
type PropsWithSpring = AnimatedProps<BaseProps>;

const AnimatedDiv = React.forwardRef<HTMLDivElement, PropsWithSpring>((props) => {
    ...
    return (
        <div className="project-wrapper" >
            <div className={`card-stack`}>
                {springs.map((style, i) => (
                    ...
                    >
                        ...
                        <img className='hero-img' src={projects[i].image}/>
            ...
            <div className="project-details">
                ...
                <br />
                <a href={projects[activeIndex].repo} target="_blank" rel="noopener noreferrer" className="repo-link">
                    GitHub Repository
                </a>
